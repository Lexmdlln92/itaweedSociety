...
const silhouettes = [
  { id: "sweatpants1", label: "Sudadera 4 faces", image: sweatpants1, modalImage: tshirt1modal },
  { id: "sweatpants2", label: "sudadera regular bolsillo", image: sweatpants2, modalImage: tshirt2modal },
  ...
  return (
    <div className="px-4 pt-6 pb-20 min-h-screen flex flex-col bg-[#2a004f]">
      ...
      <p className="text-center text-white mb-6">
        Elige una de las dos siluetas de la más alta costura
      </p>
