// src/pages/customize/ShortStep2Size.jsx
import { useLocation, useNavigate } from "react-router-dom";
import { useState } from "react";
import { motion, AnimatePresence } from "framer-motion";
import MarqueeText from "../../components/MarqueeText";

// Assets de Shorts (Mapeo corregido)
...
const sizes = [
  { id: "S", label: "S", description: '28–30"' },
  { id: "M", label: "M", description: '32–34"' },
  { id: "L", label: "L", description: '36–38"' },
  { id: "XL", label: "XL", description: '40–42"' },
  { id: "XXL", label: "XXL", description: '44–46"' },
];
...
export default function ShortStep2Size() {
  const { state } = useLocation();
  const navigate = useNavigate();

  // CAMBIO AQUÍ: Capturamos 'selectedShort' que viene de Short1Silhouettes
  const selectedShort = state?.selectedShort || "short1";
  const image = shortsMap[selectedShort] || short1;
  ...
  const handleNext = () => {
    ...
    setErrorMessage("");
    // Aquí puedes redirigir al paso 3 de pantalonetas según tu estructura
    navigate("/customize/pantalonetas/step3", {
      state: { selectedShort, selectedSize },
    });
  };

  return (
    <section className="nap-root min-h-screen w-full flex flex-col justify-between relative bg-black text-white z-10">
      <div>
        ...
        <div className="nap-hero relative z-10">
          <div className="nap-hero-eyebrow flex items-center justify-center md:justify-start gap-3">
            ...
            <span className="nap-hero-tag whitespace-nowrap">— PASO 2</span>
          </div>
        ...
        <div className="nap-body max-w-7xl mx-auto px-4 w-full mt-4 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center w-full">
            ...
            {/* COLUMNA IZQUIERDA: VISUALIZADOR DE PRENDA */}
            <div className="md:col-span-5 flex flex-col items-center justify-center">
              ...
              >
                ...
                <span className="nap-badge-tech">SILHOUETTE // {selectedShort.toUpperCase()}</span>
              </div>
            </div>
            ...
            <div className="md:col-span-7 w-full">
              ...
              <div className="mt-6 p-4 border border-neutral-900 bg-neutral-950/20 rounded-lg max-w-xl">
                ...
                <p className="font-mono text-neutral-400 text-[11px] leading-relaxed lowercase">
                  Malla premium transpirable de alta densidad / felpa vintage perchada. Cintura elástica acanalada con cordón plano de ajuste interno, bolsillos laterales profundos y herrajes premium.
                </p>
              </div>
