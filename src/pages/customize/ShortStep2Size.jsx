// ========================
// ARCHIVO 2: SweatpantsStep2Size.jsx (CORREGIDO)
// ========================

// src/pages/customize/SweatpantsStep2Size.jsx
import { useLocation, useNavigate } from "react-router-dom";
import short1 from "../../assets/customization/shortsize1.png";
import short2 from "../../assets/customization/shortsize2.png";
import short3 from "../../assets/customization/shortsize3.png";
...
export default function TshirtStep2Size() {
  ...
  const image = shortMap[selectedTshirt];
  ...
  return (
    <div className="flex flex-col min-h-screen p-4 text-white">
      ...
      <p className="text-center text-white mb-6">
        Selecciona la talla de tu sudadera y presiona continuar
      </p>
