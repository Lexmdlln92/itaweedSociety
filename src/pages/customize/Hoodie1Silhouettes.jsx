...
// Assets específicos para Hoodies
import hoodie1custom from "../../assets/customization/hoodie1.webp";
import hoodie2custom from "../../assets/customization/hoodie2.webp";
import hoodie3custom from "../../assets/customization/hoodie3.webp";
import hoodie4custom from "../../assets/customization/hoodie4.webp";
import hoodie1modal from "../../assets/customization/silueta1Modal.webp";
import hoodie2modal from "../../assets/customization/silueta2Modal.webp";
import hoodie3modal from "../../assets/customization/silueta3Modal.webp";
import hoodie4modal from "../../assets/customization/silueta4Modal.webp";
...
const silhouettes = [
  { id: "hoodie1", label: "Hoodie Classic Over", image: hoodie1custom, modalImage: hoodie1modal },
  { id: "hoodie2", label: "Hoodie Crop Zip", image: hoodie2custom, modalImage: hoodie2modal },
  { id: "hoodie3", label: "Hoodie Heavyweight", image: hoodie3custom, modalImage: hoodie3modal },
  { id: "hoodie4", label: "Hoodie Street", image: hoodie4custom, modalImage: hoodie4modal },
];
...
export default function HoodieSilhouettes() {
  ...
  const handleNext = () => {
    ...
    // CORREGIDO: Se envía 'selectedBuzo' en lugar de 'selectedTshirt' para que HoodieStep2Size lo reconozca
    navigate("/customize/buzos/step2", { 
      state: { selectedBuzo: selected } 
    });
  };
        ...
        <div className="nap-hero">
          ...
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mt-6">
            <h1 className="nap-hero-title text-center md:text-left !text-5xl md:!text-8xl leading-none">
              Elige un<br /><span>Hoodie</span>
            </h1>

            <div className="max-w-sm text-center md:text-right lg:mb-20">
              <p className="nap-hero-sub">
                Elige uno de los cortes exclusivos de abrigos y hoodies premium para iniciar el proceso de diseño de tu drop.
              </p>
            ...
            {silhouettes.map(({ id, label, image, modalImage }) => {
              ...
              return (
                <motion.div key={id} variants={cardVariants}>
                  ...
                  >
                    {/* Contenedor Imagen - Proporciones controladas sin recortes */}
                    <div className="nap-card-img w-full aspect-[3/4] flex items-center justify-center relative overflow-hidden p-4 bg-neutral-950/40 rounded-xl">
                      ...
                      <span className="nap-badge-tech">HD_DS_06</span>
