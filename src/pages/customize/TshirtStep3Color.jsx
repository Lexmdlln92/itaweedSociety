...
export default function TshirtStep3Color({ onNext }) {
  ...
  const handlePreview = () => {
    if (Object.keys(colors).length < tshirtParts.length) {
  ...
  return (
    <div className="min-h-screen bg-[#3b0057] p-4 text-white space-y-2">
      <h2 className="text-center text-2xl font-bold">Seleccionar Color</h2>
      <p className="text-center">Elige un color</p>

      {/* Vista de la camiseta */}
      <div className="relative w-[440px] h-[380px] sm:h-[500px] mb-2 mr-20">
        {tshirtParts.map(({ name, image }) => (
